...
const whiteClasses='text-black bg-white hover:text-white hover:bg-nero border-white';
...
export default function PillowLink({
  ...
  return (
    <a
      href={link}
      className={`${variant=='dark'? darkClasses:whiteClasses
    ...
    >
      {text}
      <span
        className={`${variantSvg==='whiteSvg'? whiteClassesSvg:darkClassesSvg
