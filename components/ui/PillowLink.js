...
const blueSvg = ' bg-royal-blue text-white';
const whiteSvg =
  'bg-white text-black group-hover:bg-royal-blue group-hover:text-white';
const blackSvg = 'bg-black text-white';
...
export default function PillowLink({
  ...
  return (
    ...
    >
      {text}
      <span
        className={`${svgClass} w-[37px] h-[37px] flex items-center justify-center rounded-full shrink-0 ml-12 mr-1`}
      >
