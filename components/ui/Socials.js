export default function Socials() {
  return (
    <ul className='flex'>
      <li>
        <a href='#' aria-label='Youtube' className='py-3.8 bg-nero w-[44px]
         rounded-l5 flex justify-center items-center h-[44px]'>
          <svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.8406 2.37351C15.8406 2.37351 15.6844 1.2952 15.2031
             0.821716C14.5938 0.198556 13.9125 0.195501 13.6 0.158845C11.3625 -8.43167e-08
              8.00313 0 8.00313 0H7.99687C7.99687 0 4.6375 -8.43167e-08 2.4 0.158845C2.0875
               ...
               5.33963L6.34688 7.52985Z" fill="white" />
          </svg>
        </a>
      </li >
      <li>
        <a href='#' aria-label='Телеграмм' className='py-3.8 bg-nero w-[44px]
         rounded-l5 flex justify-center items-center h-[44px]'>
          <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.06289 9.77088L6.76514 13.9101C7.19114 13.9101 7.37564 13.7292
            ...
            15.0669 2.67181 14.7331 2.96387L7.06289 9.77088Z" fill="white" />
          </svg>
        </a>
      </li>
      <li className='ml-[12px]'>
        <a href='#' aria-label='WhatsApp' className='py-3.8 bg-nero w-[44px]
         rounded-l5 flex justify-center items-center h-[44px]'>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.002 0H7.998C3.587 0 0 3.588 0 8C0 9.75 0.564 11.372 1.523
            ...
            10.032 12.737 10.088 12.794 10.187C12.85 10.286 12.85 10.751 12.657 11.297Z" fill="white" />
          </svg>
        </a>
      </li>
    </ul>
